...
export function ComparisonTable() {
  const features = [
    ...
    },
    {
      ...
      agencies: {
        icon: 'x',
        text: 'Maybe (They could be lying)',
    ...
    },
    {
      ...
      trag: {
        icon: 'check',
        text: '48 hours for most projects',
        color: 'text-green-600',
      },
      fullTime: {
        icon: 'x',
        text: 'Can take weeks due to other tasks',
        color: 'text-red-500',
      },
      agencies: {
        icon: 'x',
        text: 'Weeks, depending on workload',
        color: 'text-red-500',
      },
    },
    {
      ...
      fullTime: {
        icon: 'x',
        text: 'Weeks to onboard and train',
        color: 'text-red-500',
      },
      agencies: {
        icon: 'x',
        text: 'Days to set up agreements',
        color: 'text-red-500',
      },
    },
    {
      ...
      trag: {
        icon: 'check',
        text: "Yes, we keep working until it's perfect",
        color: 'text-green-600',
      },
      fullTime: {
        icon: 'x',
        text: 'Limited, with extra time constraints',
        color: 'text-red-500',
      },
      agencies: {
        icon: 'x',
        text: 'Limited revisions per project',
        color: 'text-red-500',
      },
    },
    {
      ...
      trag: {
        icon: 'check',
        text: 'Yes, track progress easily',
        color: 'text-green-600',
      },
      fullTime: {
        icon: 'x',
        text: 'Internal systems may vary',
        color: 'text-amber-500',
      },
      agencies: {
        icon: 'x',
        text: 'No consistent system',
        color: 'text-red-500',
      },
    },
    {
      ...
      agencies: {
        icon: 'x',
        text: "Limited by freelancer's capacity",
        color: 'text-red-500',
      },
    },
    {
      ...
      trag: {
        icon: 'check',
        text: 'Pause or adjust your subscription anytime',
        color: 'text-green-600',
      },
      fullTime: {
        icon: 'x',
