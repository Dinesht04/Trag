...
const projects: Project[] = [
  {
    id: 1,
    title: "Sound Station",
    image: "https://framerusercontent.com/images/l0idpE6V07fBAS1aCG7tUAQhM.png?scale-down-to=512",
    description:
  ...
  },
  {
    ...
    image: "https://framerusercontent.com/images/9pGqqgjCxhqbwBP314576hj3I9k.png?scale-down-to=512",
    description:
  ...
  },
  {
    ...
    image: "https://framerusercontent.com/images/eDdQZwKrMefc2yddQTsXyYzXQ.png?scale-down-to=512",
    description:
      ...
      >
        <CarouselContent className="-ml-2 md:-ml-4">
          {projects.map((project, index) => (
            <CarouselItem key={`${project.id}-${index}`} className="pl-2 md:pl-4 mx-20 basis-1/5">
              <Card
        ...
        {projects.map((_, index) => (
          <button
            ...
            className={`w-3 h-3 rounded-full transition-all duration-200 ${
              current % projects.length === index ? "bg-gray-800" : "bg-gray-300 hover:bg-gray-500"
            }`}
          />
        ))}
      </div>
